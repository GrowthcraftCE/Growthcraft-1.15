...
public class GrowthcraftCellarRecipeSerializers {
    ...
    public static final RegistryObject<IRecipeSerializer<?>> BREW_KETTLE_SERIALIZER;

    public static final IRecipeType<IBrewKettleRecipe> BREW_KETTLE_RECIPE_TYPE;

    static {
        BREW_KETTLE_SERIALIZER = RECIPE_SERIALIZERS.register(
                UnlocalizedName.BREW_KETTLE,
                () -> BREW_KETTLE_RECIPE_SERIALIZER);

        BREW_KETTLE_RECIPE_TYPE = registerType(IBrewKettleRecipe.RECIPE_TYPE_ID);
    }
