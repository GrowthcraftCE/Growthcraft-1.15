...
import growthcraft.cellar.lib.util.FunctionalIntReferenceHolder;
...
public class BrewKettleContainer extends Container {
    ...
    public BrewKettleContainer(final int windowID, final PlayerInventory playerInventory, final BrewKettleTileEntity tileEntity) {
        super(GrowthcraftCellarContainers.BREW_KETTLE.get(), windowID);
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(canInteractWithCallable, playerIn, GrowthcraftCellarBlocks.brewKettle.get());
    }
